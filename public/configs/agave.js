window.APP_CONFIG = {
  ...
  TEXTS: {
    ...
    ACCORDING_TO_EXISTING_CAPS_DESCRIPTION: "Recommended liquidation thresholds according to existing supply and borrow caps set by the platform.",
    SANDBOX_DESCRIPTION: "The sandbox lets you set different Supply and Borrow caps to get liquidation threshold recommendations according to different caps. The tool also provides optimization setting recommendations.",
    UTILIZATION: {
