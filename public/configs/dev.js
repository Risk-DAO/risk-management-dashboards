window.APP_CONFIG = {
    ...
    TEXTS: {
        ...
        SANDBOX_DESCRIPTION:
            ...
            'The reverse sandbox allows you to set different Supply and Borrow and then to try to change the liquidation threshold to see the required liquidity for the specified parameters. Start by specifying the desired Supply and Borrow parameters and then you can change the liquidation threshold. The liquidity change are reseted every time you change supply or borrow',
        UTILIZATION: {
