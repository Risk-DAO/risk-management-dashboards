  ...
  render() {
    ...
    return (
      <div style={{ display: 'flex', width: '100%' }}>
        <details onClick={this.toggle} open={props.row[props.name]} style={{ padding: '1rem 0', border: 'none', marginBottom: '0', width: usersMinWidth, overflow: 'auto', overflowX: 'hidden' }}>
