...
const columns = [
    ...
    },
    {
        ...
        format: (row) => (
            <CapInputGeneric
                val={displayCap(row.borrowCap)}
                increment={() => vestaRiskStore.increment(row, 'borrowCap')}
                decrement={() => vestaRiskStore.decrement(row, 'borrowCap')}
            />
        ),
    },
    {
        ...
        format: (row) => (
            <CapInputGeneric
                val={displayPercentage(row.stabilityPoolSize)}
                increment={() => vestaRiskStore.increment(row, 'stabilityPoolSize')}
                decrement={() => vestaRiskStore.decrement(row, 'stabilityPoolSize')}
            />
        ),
    },
    {
        ...
        format: (row) => (
            <CapInputGeneric
                val={displayPercentage(row.bprotocolSize)}
                increment={() => vestaRiskStore.increment(row, 'bprotocolSize')}
                decrement={() => vestaRiskStore.decrement(row, 'bprotocolSize')}
            />
        ),
    },
    {
