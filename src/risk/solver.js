export default class Solver {
    ...
    findValidCfg(mintCaps, borrowCaps, cfs) {
                    ...
                    if (dc >= mintCaps[long]) {
                        ...
                        if (cfs[long] === cf)
                            efficientFrontier.push({
                                ...
                                short: short,
                                change: 'mintCap',
                                recommendation: 'decrease ' + long + ' mint cap to ' + prevDc.toString(),
                                newCap: prevDc,
                            })
                    }
                    if (dc >= borrowCaps[short]) {
                        ...
                        if (cfs[long] === cf)
                            efficientFrontier.push({
                                ...
                                short: short,
                                change: 'borrowCap',
                                recommendation: 'decrease ' + short + ' borrow cap to ' + prevDc.toString(),
                                newCap: prevDc,
                            })
                    }
        ...
        return {
            mintCaps: resultMintCaps,
            borrowCaps: resultBorrowCaps,
            cfs: resultCfs,
            valid,
            efficientFrontier,
        }
    ...
    recommendCfIncrease(cfg, asset) {
        ...
        return { mintCap: { asset: asset, cap: long }, borrowCap: short }
    }
